...
labels = open(MODELS_PATH + '/ObjectDetection/object/src_code/src/coco.names').read().strip().split('\n')
...
weights_path = MODELS_PATH + '/ObjectDetection/object/src_code/src/yolov4.weights'
# loading the configaration file of Yolo3
#configuration_path = 'C:/Users/RNALAB/Downloads/Object/bin/yolov3.cfg'
configuration_path = MODELS_PATH + '/ObjectDetection/object/src_code/src/yolo4.cfg'
    ...
    try:
        ...
        if len(results) > 0:
            ...
            for i in results.flatten():
                ...
                text_box_current = '{}: {:0.1f}'.format(labels[int(class_numbers[i])], confidences[i])
        ...
        excel_filename = "Object_Detection" +".xlsx"
        df.to_excel(BASE_DIR+'/media/' +excel_filename)
        df_filepath = '/media/' +excel_filename
        cv2.imwrite(BASE_DIR + '/media/model_output2.jpg', image_input)
